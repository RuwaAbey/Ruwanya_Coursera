...
This will stop compilation after preprocessing has completed. Also specifies theoutput file to store as the preprocessed file (using the -o <FILE> option). All warnings will be treated as errors and use the c99 c-standard.
